 ...
 */
final class Version20241103233136 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ligue1_teams (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, coach VARCHAR(255) NOT NULL, short_name VARCHAR(255) DEFAULT NULL, tla VARCHAR(5) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, founded INT DEFAULT NULL, venue VARCHAR(255) DEFAULT NULL, api_id VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE players (id INT AUTO_INCREMENT NOT NULL, team_id INT NOT NULL, birthday DATETIME NOT NULL, position VARCHAR(255) NOT NULL, full_name VARCHAR(255) NOT NULL, date_of_birth DATE NOT NULL, name VARCHAR(255) NOT NULL, nationality VARCHAR(255) DEFAULT NULL, api_id INT NOT NULL, INDEX IDX_264E43A6296CD8AE (team_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
